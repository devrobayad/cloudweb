...
export const defaultSolutions: Record<string, SerializableSolution> = {
  conference: {
    id: "conference",
  ...
  "cctv-storage": {
    id: "cctv-storage",
    title: "Surveillance Centralized Storage",
  ...
  "cctv-centralized": {
    id: "cctv-centralized",
    title: "Centralized Surveillance Room",
  ...
  "conf-meeting-room": {
    ...
    title: "Smart Meeting Room Solution",
  ...
  "sound-ip-pa": {
    id: "sound-ip-pa",
    title: "IP Public Address PA System",
  ...
  "sound-pa": {
    ...
    features: [
      ...
      { title: "Fire Alarm Emergency Override", desc: "Built-in priority override triggers that mutes background music and blasts evacuation tracks in high danger." },
  ...
  "access-biometric": {
    ...
    features: [
      ...
      { title: "USB Offsite Logs Retrieval", desc: "Enables manual logs retrieval using standard USB drives during sudden connectivity drops." },
